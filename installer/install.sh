...
openssl rand -base64 $((( $(( $RANDOM % 64 )) + 100 ))) | tr -dc 'a-zA-Z0-9' > /home/nextcloud/storage/secrets/mysql_root_password
openssl rand -base64 $((( $(( $RANDOM % 64 )) + 100 ))) | tr -dc 'a-zA-Z0-9' > /home/nextcloud/storage/secrets/mysql_user_password
openssl rand -base64 $((( $(( $RANDOM % 64 )) + 100 ))) | tr -dc 'a-zA-Z0-9' > /home/nextcloud/storage/secrets/redis_password
