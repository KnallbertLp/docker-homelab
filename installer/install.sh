...
sudo crontab -u nextcloud -l > mycron; echo '@reboot cd /home/nextcloud && docker-compose up -d' >> mycron && echo '0 * * * * cd /home/nextcloud && docker-compose up -d' >> mycron && echo '*/5 * * * * curl http://127.0.0.1/cron.php' >> mycron && crontab -u nextcloud mycron && rm -rf mycron
sudo ufw allow 80
